#!/bin/bash -   
#title          :sub_bfg-configure.sh
#description    :Install for BFG-MINING
#author         :Steven J. Martin
#date           :20140222
#version        :${version}
#usage          :./sub_bfg-configure.sh
#notes          :       
...
retval=$?
	...
	echo "${INSLOC}/${SUBject}/bfgminer -c ${INSLOC}/${SUBject}/${SUBject}.`date +%b%d%Y`.conf">>${INSLOC}/${SUBject}/${SUBject}.sh
