#!/bin/bash -   
#title          :sub_cgm-install.sh
#description    :Install for GPU-MINING|ASICS
#author         :Steven J. Martin
#date           :20140222
#version        :${version}
#usage          :./sub_cgm-install.sh
#notes          :       
...
ln -s ${myinstalloc}/cgminer-3.7.2 ${SUBject} 
cd ${SUBject}
./configure --enable-bflsc --enable-icarus --enable-bitforce --enable-modminer
make clean
make
${MySudoCom}make install
${MySudoCom}ldconfig
${MySudoCom}lsusb
${MySudoCom}modprobe -r
echo "Testing ..."
echo "`pwd` ..."
